<header id="headerBlock">
    <div id="HlogoBlock"><!--the logo of header-->
        <a href="index.php"><img src="images/logos/Shopamo logo.svg" alt="shopamo.shop" id="headerLogo" width="40%" ></a>
    </div>
    ...
    <div id="cartBlock">
        <a href="panier.php">
            <h5 style="display: flex; align-items:center;margin:0%;font-size:1.2em"><img src="images/logos/cart logo.svg" alt="" width="95%">
                <?php
