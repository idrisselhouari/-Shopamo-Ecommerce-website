    ...
    <div id="mainPage">
        <div class ="products" >
                ...
                if(!empty($_GET['idCategorie'])){
                    ...
                    $products= $con->query("SELECT * FROM products WHERE categorieId=$id");
                    $categorie=$con->query("SELECT * FROM sousCategories WHERE categorieId=$id");
                    $categorieLine=$categorie->fetch();
                    echo '<div class = "container">';
                        //the categories're Title and description 
                        echo '<h1 class = "lg-title">'.$categorieLine['categorieName'].'</h1>';
                        echo '<p class = "text-light">'.$categorieLine['categorieDescription'].'</p>';
                        /***************************************************** */
...
<?php include 'Panier/panier categorie.php';  ?>